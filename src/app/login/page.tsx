      ...
      <div className="flex lg:items-center justify-center w-full h-full">
        <div className="flex w-full lg:w-1/2 p-8 items-center justify-center">
          <div className="h-full">
            <h1 className="lg:hidden text-3xl font-semibold font-serif animate-appearance-in mb-5 mt-2">
              Welcome to<span><br/> </span>
              <Link
                href="/"
                className={`${lobster.className} story-pilot-link text-3xl font-bold cursor-pointer text-center`}
              >
            ...
            <div className="flex flex-col p-6 bg-black py-8 rounded-lg login-card-shadow">
              ...
              <Link href="/register" className="hover:border-b-1 border-blue-700 text-gray-300">Don't have an account? Sign Up here</Link>
              </div>
            </div>
          </div>
        </div>
